...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Grand Citra Busana adalah toko fashion online, yang menyediakan segala kebutuhan fashion anda. Grand Citra Busana ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja fashion berkualias dengan harga yang terjangkau.            </p>
        ...
        <div class="copyright_network">
        	<p>Copyright ©2016 Develoved by: Arwenda </p>
            <ul class="network"><li>
